...
namespace WebAPI.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<IProductRepo>().To<ProductManager>().InRequestScope();
            kernel.Bind<ICategoryRepo>().To<CategoryManager>().InRequestScope();
            kernel.Bind<IStoreRepo>().To<StoreManager>().InRequestScope();
        }
    }
}